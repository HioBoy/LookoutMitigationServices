...
public class EdgeLocationsHelperTest {
    ...
    public void testHappyCase() throws Exception {
        ...
        when(edgeServicesGetPOPsCall.call(getPOPsRequest)).thenReturn(edgeServicesGetPOPsResult);
        ...
        EdgeLocationsHelper locationsHelper = new EdgeLocationsHelper(edgeServicesClient, daasClient, 1, "dir", new NullMetricsFactory(), new ArrayList<String>());
    ...
    public void testCloudFrontCustomerAPIFailureCase() throws Exception {
        ...
        GetPOPsRequest getPOPsRequest = new GetPOPsRequest();
        getPOPsRequest.setType("pop");
        when(edgeServicesGetPOPsCall.call(getPOPsRequest)).thenThrow(new RuntimeException());
        when(edgeServicesClient.newGetPOPsCall()).thenReturn(edgeServicesGetPOPsCall);
    ...
    public void testInitialSuccessButSomeRefreshFailuresLater() throws Exception {
        ...
        GetPOPsRequest getPOPsRequest = new GetPOPsRequest();
        getPOPsRequest.setType("pop");
        when(edgeServicesGetPOPsCall.call(getPOPsRequest)).thenReturn(edgeServicesGetPOPsResult).thenThrow(new RuntimeException()).thenThrow(new RuntimeException()).thenThrow(new RuntimeException());
        when(edgeServicesClient.newGetPOPsCall()).thenReturn(edgeServicesGetPOPsCall);
    ...
    public void testLoadPOPsFromDiskOnStartupWithUnsuccessfulCFPopsRefresh() throws Exception {
        ...
        EdgeLocationsHelper locationsHelper = new EdgeLocationsHelper(edgeServicesClient, daasClient, 1, TestUtils.getTstDataPath(EdgeLocationsHelper.class), new NullMetricsFactory(), new ArrayList<String>());
    ...
    public void testFlushPOPsFromDisk() throws Exception {
        ...
        EdgeLocationsHelper locationsHelper = new EdgeLocationsHelper(edgeServicesClient, daasClient, 1, tempDir, new NullMetricsFactory(), new ArrayList<String>());
        Set<String> allClassicPOPs = locationsHelper.getAllClassicPOPs();
        assertEquals(expectedPOPs, allClassicPOPs);
        ...
        List<List<String>> lines = FileUtils.readFile(flushedFile.getAbsolutePath(), ",",
