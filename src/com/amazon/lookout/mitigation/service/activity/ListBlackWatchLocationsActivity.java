...
public class ListBlackWatchLocationsActivity extends Activity {
    ...
    @ConstructorProperties({"locationStateInfoHandler"})
    public ListBlackWatchLocationsActivity(@NonNull LocationStateInfoHandler locationStateInfoHandler) {
    ...
    public @NonNull ListBlackWatchLocationsResponse enact(@NonNull ListBlackWatchLocationsRequest request) {
        ...
        try {            
            ...
            // Step 1. Fetch list of BlackWatch locations and their AdminIn state
            List<BlackWatchLocations> listOfLocationsAndAdminInState = locationStateInfoHandler.getBlackWatchLocations(tsdMetrics);
