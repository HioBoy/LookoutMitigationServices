...
public class CreateMitigationActivity extends Activity {
    ...
    public @Nonnull MitigationModificationResponse enact(@Nonnull MitigationModificationRequest mitigationModificationRequest) {
        ...
        try {
            LOG.info(String.format("Request for CreateMitigationActivity: %s.", ReflectionToStringBuilder.toString(mitigationModificationRequest)));            
            ...
            LOG.warn(String.format("Bad request while fulfilling request for CreateMitigationActivity: %s.", ReflectionToStringBuilder.toString(mitigationModificationRequest)), badRequest);            
            tsdMetrics.addCount(LookoutMitigationServiceConstants.INTERNAL_FAILURE, 0, Unit.ONE);
            throw badRequest;
        } catch (Exception internalError) {       

            LOG.error(String.format("Internal error while fulfilling request for CreateMitigationActivity: %s.", ReflectionToStringBuilder.toString(mitigationModificationRequest)), internalError);
