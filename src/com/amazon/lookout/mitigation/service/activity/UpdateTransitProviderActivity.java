    ...
    public @Nonnull UpdateTransitProviderResponse enact(@Nonnull UpdateTransitProviderRequest request) {
        ...
        try { 
            ...
            try {
                ...
                tsdMetrics.addOne(CommonActivityMetricsHelper.EXCEPTION_COUNT_METRIC_PREFIX + UpdateTransitProviderExceptions.BadRequest.name());
            ...
            LOG.info(message + " for request: " + ReflectionToStringBuilder.toString(request), ex);
            requestSuccessfullyProcessed = false;
            tsdMetrics.addOne(CommonActivityMetricsHelper.EXCEPTION_COUNT_METRIC_PREFIX + UpdateTransitProviderExceptions.StaleRequest.name());
